...
public static Object[]  _vvvvvvvvvvvvvvvvvvv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
...
if (true) return (Object[])(_list1.Get(_vv5));
 //BA.debugLineNum = 206;BA.debugLine="End Sub";
return null;
}
public static String  _vvv1(anywheresoftware.b4a.BA _ba,String _key) throws Exception{
...
if (true) return _vvv2(_ba,_key,"");
 //BA.debugLineNum = 30;BA.debugLine="End Sub";
return "";
}
public static String  _vvv2(anywheresoftware.b4a.BA _ba,String _key,String _defaultvalue) throws Exception{
String _v = "";
...
if (_vv0.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 16;BA.debugLine="If File.Exists(File.DirInternal, settingsFileNam";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv7)) { 
 //BA.debugLineNum = 17;BA.debugLine="settings = File.ReadMap(File.DirInternal, setti";
_vv0 = anywheresoftware.b4a.keywords.Common.File.ReadMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv7);
 }else {
...
_v = BA.ObjectToString(_vv0.GetDefault((Object)(_key.toLowerCase()),(Object)(_defaultvalue)));
 //BA.debugLineNum = 24;BA.debugLine="Return v";
if (true) return _v;
 //BA.debugLineNum = 25;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvvvvvvvvv7(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
...
_data = _vvvvvvvvvvvvvvvvvvv6(_ba,_list1);
...
_vvvvvvvvvvvvvvvvvvv7(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
...
_vvvvvvvvvvvvvvvvvvv7(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
...
_vvvvvvvvvvvvvvvvvvv7(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvvvvvvvvvvvvvvvvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
anywheresoftware.b4a.objects.EditTextWrapper _edit = null;
anywheresoftware.b4a.objects.SpinnerWrapper _spinner1 = null;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _check = null;
...
_vvvvvvvvvvvvvvvvvvv0(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
 }else if(_v.getObjectOrNull() instanceof android.widget.ScrollView) { 
...
_vvvvvvvvvvvvvvvvvvv0(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
 }else if(_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
...
_vvvvvvvvvvvvvvvvvvv0(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvvvvvvvvvvvvvvvvvv1(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (_vv4.IsInitialized()) { 
if (true) return "";};
 //BA.debugLineNum = 240;BA.debugLine="If File.Exists(File.DirInternal, statesFileName)";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv6)) { 
...
_raf.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv6,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 243;BA.debugLine="states = raf.ReadObject(0)";
_vv4.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_raf.ReadObject((long) (0))));
...
_vv6 = BA.__b (new byte[] {34,50,44,-75,56,96,118,-72,47}, 467202);
 //BA.debugLineNum = 8;BA.debugLine="settingsFileName = \"settings.properties\"";
_vv7 = BA.__b (new byte[] {34,35,-126,30,52,32,-50,1,117,56,-100,28,33,97,-121,14,60,43,-111}, 769328);
 //BA.debugLineNum = 9;BA.debugLine="Dim settings As Map";
_vv0 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 10;BA.debugLine="End Sub";
return "";
}
public static String  _vvv3(anywheresoftware.b4a.BA _ba,String _activityname) throws Exception{
...
_vv4.Remove((Object)(_activityname.toLowerCase()));
 //BA.debugLineNum = 56;BA.debugLine="writeStateToFile";
_vvvvvvvvvvvvvvvvvvvv2(_ba);
 };
 //BA.debugLineNum = 58;BA.debugLine="End Sub";
return "";
}
public static boolean  _vvv4(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname,int _validperiodinminutes) throws Exception{
...
if (_vv4.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
...
_list1.setObject((java.util.List)(_vv4.Get((Object)(_activityname.toLowerCase()))));
...
_vvvvvvvvvvvvvvvvvvv7(_ba,_activity.GetView(_i),_list1);
 }
};
...
if (_vv0.IsInitialized()) { 
 //BA.debugLineNum = 47;BA.debugLine="File.WriteMap(File.DirInternal, settingsFileName";
anywheresoftware.b4a.keywords.Common.File.WriteMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv7,_vv0);
 };
 //BA.debugLineNum = 49;BA.debugLine="End Sub";
return "";
}
public static String  _vvv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname) throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
int _i = 0;
...
_vvvvvvvvvvvvvvvvvvv0(_ba,_activity.GetView(_i),_list1);
 }
};
 //BA.debugLineNum = 68;BA.debugLine="states.Put(ActivityName.ToLowerCase, list1)";
_vv4.Put((Object)(_activityname.toLowerCase()),(Object)(_list1.getObject()));
 //BA.debugLineNum = 69;BA.debugLine="writeStateToFile";
_vvvvvvvvvvvvvvvvvvvv2(_ba);
 //BA.debugLineNum = 70;BA.debugLine="End Sub";
return "";
}
public static String  _vvv7(anywheresoftware.b4a.BA _ba,String _key,String _value) throws Exception{
...
_vv0.Put((Object)(_key.toLowerCase()),(Object)(_value));
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvvvvvvvvvv2(anywheresoftware.b4a.BA _ba) throws Exception{
anywheresoftware.b4a.randomaccessfile.RandomAccessFile _raf = null;
...
_raf.WriteObject((Object)(_vv4.getObject()),anywheresoftware.b4a.keywords.Common.True,_raf.CurrentPosition);
